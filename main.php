    ...
    <div class="row">
      <div class="col-md-6 col-lg-4 mb-4">
        <div class="card item-card h-100 border-0 shadow-sm">
          <div class="item-img-box">
            <img
              src="./img/ニッシーマウス　ぬいぐるみ.png"
              class="card-img-top"
              alt="BBランドオリジナル ぬいぐるみ" />
          ...
          <div class="card-body d-flex flex-column">
            ...
            <p
              ...
              ¥3,200 <span class="tax-in text-muted fs-6">(税込)</span>
            </p>
    ...
    <div class="row">
      <div class="col-md-6 col-lg-4 mb-4">
        <div class="card item-card h-100 border-0 shadow-sm">
          <div class="item-img-box">
            <img
              src="./img/23DE3C3980E522235F2938C501F66BE0A438B788.jpg"
              class="card-img-top"
              alt="コースター名" />
          ...
          <div class="card-body d-flex flex-column">
            <h3 class="card-title item-name fs-5 fw-bold">
              キング・オブ・コースター「BBコズミック」
            </h3>
            <p class="card-text text-muted small mt-2">
              銀河を駆け抜けるような超高速ループと、最大傾斜80度からの急降下を体感せよ！
            </p>
      ...
      <div class="col-md-6 col-lg-4 mb-4">
        <div class="card item-card h-100 border-0 shadow-sm">
          <div class="item-img-box">
            <img
              src="./img/618099899929461411.jpg"
              class="card-img-top"
              alt="コースター名" />
      ...
      <div class="col-md-6 col-lg-4 mb-4">
        <div class="card item-card h-100 border-0 shadow-sm">
          <div class="item-img-box">
            <img
              src="./img/93114F39404579A39493E5E4A94BF7F9A4516DA8.jpg"
              class="card-img-top"
              alt="コースター名" />
